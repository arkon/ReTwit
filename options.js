$("#name").html("ReTwit for Twitter " + chrome.app.getDetails().version);

var storage = chrome.storage.sync;

var fonts = ["Anonymous Pro", "Arial", "Arvo", "Droid Sans", "Droid Serif", "Maven Pro", "Open Sans", "Ovo", "PT Mono", "PT Sans", "PT Serif", "Raleway", "Roboto", "Roboto Condensed", "Roboto Slab", "Source Code Pro", "Source Sans Pro", "Tahoma", "Times", "Ubuntu"];
...
$(document).ready(function() {
  ...
  $("#btnReset").click(function(){
    ...
    $("#width3").val("1200");
    $("#chosenWidth3").html("Content width (3 columns): 1200px");
    $("#fade").val("70");
...
function loadChanges() {
  storage.get(["barcolor", "iconcolor", "corners", "width2", "width3", "fade", "shadow", "roundavatars", "previews", "labels", "flip",
    "sidebar", "miniprofile", "miniprofilenormal", "miniprofilewide", "wtf", "trends", "footer", "font"], function(items) {
    if (items["barcolor"])
